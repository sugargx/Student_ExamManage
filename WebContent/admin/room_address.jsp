							...
							<table class="table">
								...
								<tbody>
									<%
										...
										List<address> addresss = addressd.getAllAddress();
										for (address a1 : addresss) {
									%>
									<tr>
										<td><%=a1.getAddress_id() %></td>
										<td><%=a1.getAddress_name() %></td>

										<td>
											<form action="editAddress.jsp?address_id=<%=a1.getAddress_id()%>"
											...
											<form
												action="/GradeMan/delAddress?address_id=<%=a1.getAddress_id()%>"
												method="post" style="display: inline">
