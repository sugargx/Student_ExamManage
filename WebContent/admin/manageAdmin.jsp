					...
					<div class="card">
						...
						<div class="card-body" style="padding: 30px 15%">
							...
							<form class="form form-horizontal" method="post"
								action="/GradeMan/manageAdmin" name="form1">
								<input type="hidden" value="launch" name="action" />

								<div class="form-group">
									<label class="col-md-3">账号<span style="color: red">*（账号不可重复）</span></label>
									<div class="col-md-9 col-sm-12">
										<input type="text" class="form-control" value=""
											name="username" id="username" placeholder="请输入管理员账号" required>
									</div>
								</div>


								<div class="form-group">
									<label class="col-md-3">密码<span style="color: red">*</span></label>
									<div class="col-md-9 col-sm-12">
										<input type="password" class="form-control"
											name="password" id="password" value="" placeholder="请输入密码" required>
									</div>
								</div>
							
								<div class="form-group" style="margin-bottom: 50px">
									<label class="col-md-3">管理员权限<span style="color: red">*</span></label>
									<div class="col-md-9 col-sm-12">
										<label><input name="rank" type="radio"
											value="1" / checked>管理员 </label>
										<label><input
											name="rank" type="radio" value="0" />超级管理员 </label>
									</div>
								</div>
