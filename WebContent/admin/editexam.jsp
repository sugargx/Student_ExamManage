      ...
      <div class="dropdown-container">
		...
		<div class="app-container">
			...
			<div class="row">
				...
				<!-- 搜索 -->
				<div class="col-lg-6 col-md-6 col-sm-6">
					<form method="post" action="/GradeMan/SearchExam"
						style="display: flex;">
				...
				<div class="col-md-12 col-sm-12">
					<div class="card">
							...
							<table class="table">
								...
								<tbody>
									<%
										...
										Page<exam> pg = pd.findAllexamWithPage(pageNum, pageSize);

										for (exam exam1 : pg.getList()) {
									%>
						...
						: exam1.getTime().toString().substring(0, 19)%></td>
										...
										<td>
											<form action="detailexam.jsp?exam_id=<%=exam1.getExam_id()%>"
											...
											<form
												action="editexam_detail.jsp?exam_id=<%=exam1.getExam_id()%>"
												method="post" style="display: inline">
											...
											<form
												action="/GradeMan/delExam?exam_id=<%=exam1.getExam_id()%>"
												method="post" style="display: inline">
