					...
					<div class="card">
						...
						<div class="card-body">
							...
							<table class="table">
								...
								%>
									<tr>
										<td><%=a1.getAdmin_id() %></td>
										<td><%=a1.getUsername() %></td>

										<td><%=a1.getPassword() %></td>
										<td><%=a1.getRank() == 0? "超级管理员":"管理员" %></td>


										<td>
											<form
												action="editAdmin.jsp?admin_id=<%=a1.getAdmin_id()%>"
											...
											<form
												action="/GradeMan/delAdmin?admin_id=<%=a1.getAdmin_id()%>"
												method="post" style="display: inline">
