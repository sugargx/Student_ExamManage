					...
					<div class="card">
						...
						<div class="card-body">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<form
												action="/GradeMan/delExamRoomNext?room_id=<%=exam_room1.getRoom_id() %>"
												method="post" style="display: inline">
							...
							<ul class="pagination" style="margin-top: 50px;">
								...
								%>
								<li><a
									href="/GradeMan/adminNext/editexam.jsp?pageNum=<%=pageNum - 1%>">«</a></li>
								<%
									}
								%>
								<%
								...
								%>
								<li><a href="/GradeMan/adminNext/editexam.jsp?pageNum=<%=i%>"
									<%if (pageNum == i) {%>
