...
<script>
 function checkpnum(num){
	 if(num == 0){
		 alert('暂无学生通过此考试报名审核！无法对学生进行考场分配！');
		 return false;
	 }
	 else{
		...
		<div class="app-container">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 city_type">
					<form method="get" action="/GradeManNext/SearchExam"
						style="display: flex;">
				...
				<div class="col-md-12 col-sm-12">
					<div class="card">
						...
						<div class="card-body">
							<table class="table">
								...
								<tbody>
								    ...
								    List<exam> exams2 = exd.getAllAdmin(admin_id);
								    
								    exams.retainAll(exams2);
						...
						: exam1.getTime().toString().substring(0, 19)%></td>
										...
										<td>
											<form action="signStudentAll.jsp?exam_id=<%=exam1.getExam_id()%>"
												method="post" style="display: inline">

												<input type="submit" class="btn btn-primary btn-xs" onclick="return checkpnum(<%=exam1.getSign_num() %>)"
													value="分配">
											</form>
										</td>
									</tr>
