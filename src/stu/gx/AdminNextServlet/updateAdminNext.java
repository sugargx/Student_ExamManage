 ...
 */
public class updateAdminNext extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateAdminNext() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       if(b==true) {
    	   out.print("<script language='javascript'>alert('修改成功！');window.location.href='/GradeMan/adminNext/showAdmin.jsp';</script>");
       }else {
    	   out.print("<script language='javascript'>alert('修改失败！账号名不能重复！');window.location.href='/GradeMan/adminNext/editAdmin.jsp';</script>");
       }
