 ...
 */
public class SearchExamNext extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchExamNext() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(oneExam==null) {//如果没有此考试
			exam_id = 0;
			out.print("<script language='javascript'>window.location.href='/GradeMan/adminNext/searchOneExam.jsp?exam_id="+exam_id+"';</script>");
