 ...
 */
public class updateExamRoomNext extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateExamRoomNext() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<script language='javascript'>alert('ÐÞ¸Ä³É¹¦£¡');window.location.href='/GradeMan/adminNext/manageExamRoom.jsp';</script>");
