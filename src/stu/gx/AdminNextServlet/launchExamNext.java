 ...
 */
public class launchExamNext extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public launchExamNext() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       try {
		...
		if(b) {
			Edao.add(er);
			out.print("<script language='javascript'>alert('发布成功！');window.location.href='/GradeMan/adminNext/editexam.jsp';</script>");
		}
		else {
			out.print("<script language='javascript'>alert('添加失败！该考场名字已存在！请重新填写考试名');window.location.href='/GradeMan/adminNext/launchExam.jsp';</script>");
		}
