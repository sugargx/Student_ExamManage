 ...
 */
public class arrangeExam_room extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public arrangeExam_room() {
        super();
...
//		所有报名此考试的用户
		...
		out.print("<script language='javascript'>alert('分配成功！');window.location.href='/GradeMan/admin/signStudentAll.jsp?exam_id="+exam_id+"';</script>");
	}
