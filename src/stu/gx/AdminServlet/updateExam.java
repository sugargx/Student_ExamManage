...
public class updateExam extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       if(Edao.update(er)) {
    	   out.print("<script language='javascript'>alert('修改成功！');window.location.href='/GradeMan/admin/editexam.jsp';</script>");
       }else {
    	   out.print("<script language='javascript'>alert('修改失败！');window.location.href='/GradeMan/admin/editexam_detail.jsp';</script>");
       }
	}
