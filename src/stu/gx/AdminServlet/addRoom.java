...
//				根据选的考试名称得到考试号
				...
				Edao.add(er);
				out.print(
						"<script language='javascript'>alert('添加成功！');window.location.href='/GradeMan/admin/manageExamRoom.jsp';</script>");
			} else {
				out.print(
						"<script language='javascript'>alert('添加失败！该考场名已存在！请重新填写考场名！');window.location.href='/GradeMan/admin/addExamRoom.jsp';</script>");
			}
		}
