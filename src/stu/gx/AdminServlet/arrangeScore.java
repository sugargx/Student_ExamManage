 ...
 */
public class arrangeScore extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		signD.updateS(signup1);
			...
			out.print("<script language='javascript'>alert('成绩更新成功！');window.location.href='/GradeMan/admin/StudentScore.jsp?exam_id="
					+ exam_id + "';</script>");
