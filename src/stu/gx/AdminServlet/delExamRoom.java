 ...
 */
public class delExamRoom extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(b) {
				...
				out.print("<script language='javascript'>alert('É¾³ý³É¹¦£¡');window.location.href='/GradeMan/admin/adminIndex.jsp';</script>");
